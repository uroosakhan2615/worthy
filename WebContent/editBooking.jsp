...
<div class="modal" id="editBookingModal">
	<div class="modal-dialog">
		<!-- Modal content-->
		<s:form class="form-horizontal" action="editBooking" method="post">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							<fieldset>
								<input type="hidden" name="event.id" value="${editBooking.id}"/>
								
								<div class="form-group row">
									<label class="col-md-4 control-label">User</label>
									<div class="col-md-8">
										<input id="marqueeName" name="event.eventName" type="text"
											placeholder="Marquee Name" class="form-control input-md" value="${editBooking.user.userName}"
											required>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-8">
										<textarea name="event.description" class="form-control input-md">${editBooking.fromDate}</textarea>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-8">
										<input id="editStartDate" name="startDateStr" type="text"
											placeholder="Start Date" class="form-control input-md" value="<s:date name="editBooking.startDate" format="dd/MM/yyyy" />"
											required>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-md-8">
										<input id="editEndDate" name="endDateStr" type="text"
											placeholder="End Date" class="form-control input-md" value="<s:date name="editBooking.endDate" format="dd/MM/yyyy" />"
											required>
									</div>
								</div>
