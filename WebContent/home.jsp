															...
															<div id="myTabContent" class="tab-content">
																			...
																			<div class="form-group">
																				...
																				<div class="controls">
																					<input type="text" id="username" name="userId"
																						placeholder="Enter username" class="form-control input-xlarge">
																				</div>
																			</div>
																...
																<div class="tab-pane fade" id="create">
																	<form id="tab">
																		...
																		<input type="text" value="" class="form-control input-xlarge">
																		<label>Last Name</label> <input type="text" value="" class="form-control input-xlarge"> <label>Email</label>
																		<input type="text" value="" class="form-control input-xlarge"> <label>Address</label>
																		<textarea value="Smith" rows="3" class="form-control input-xlarge"></textarea>
																		<div class="form-group">
					...
					<div class="col-md-12">
						<form class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="city" class="form-control input-sm datepicker"
							...
							<div class="form-group">
								<label for="marquee name" class="col-sm-2 control-label">
									Marquee Name</label>
								<div class="col-sm-10">
									<input type="marquee name"
										class="form-control input-sm datepicker" id="calander"
										placeholder="marquee name">
								</div>
							</div>
							<div class="form-group">
								<label for="hall" class="col-sm-2 control-label"> Hall</label>
								<div class="col-sm-10">
									<input type="hall" class="form-control input-sm datepicker"
