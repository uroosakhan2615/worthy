			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 object-non-visible"
										...
										<div class="row">
											<div class="col-md-8"
												...
												<ul class="nav nav-tabs">
													<li class=""><a href="#Login" data-toggle="tab"
														aria-expanded="false">Login</a></li>
													<li class="active"><a href="#Registration"
														data-toggle="tab" aria-expanded="true">Registration</a></li>
												</ul>
												<!-- Tab panes -->
						...
						<div class="modal fade" id="bookMarquee" tabindex="-1"
							...
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal"
											aria-hidden="true">×</button>
										<h4 class="modal-title" id="myModalLabel">Book a Marquee
										</h4>
									</div>
									<div class="modal-body">
										<div class="row">
											<div class="col-md-12">
												<form class="form-horizontal">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<input type="city"
																class="form-control input-sm datepicker" id="city"
																placeholder="city">
														</div>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-sm-10">
															<input type="hall"
																class="form-control input-sm datepicker" id="hall"
																placeholder="hall">
														</div>
													</div>
													<div class="form-group">
